...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Duda Rubert (@duda.rubert) • Fotos e vídeos do Instagram</title>
            ...
            <div className="w-[90%] bg-black p-5 rounded-xl">
              <div className="w-full flex items-center gap-2 mb-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-semibold">duda.rubert</span>
          ...
          <>
            ...
            <div className="w-full flex flex-col justify-center items-start gap-4 px-4 mt-8">
              <div className="w-full flex items-center justify-between">
                ...
                <div className="flex-1 ml-8">
                  <div className="flex justify-between text-center">
                    ...
                    <div>
                      <div className="font-bold">2,9 mi</div>
                      <div className="text-xs">seguidores</div>
                    </div>
                    <div>
                      <div className="font-bold">1.292</div>
              ...
              <div>
                ...
                <p className="text-sm">• tiktok: duda</p>
                <p className="text-sm">contato: dudarubert@hsadigital.com.br</p>
                <p className="text-sm text-[#1977F2]">Ver tradução</p>
                <Link href="/only">https://onlyfans.com/duda.rubert</Link>
            ...
            <div className="w-full flex justify-start p-4">
              <div className="flex flex-col items-center gap-1">
                <Image
                  ...
                  className="rounded-[50%] border-2 border-white"
                />
                <p className="text-xs">Cirurgia</p>
              </div>
            </div>
